...
var Name = map[uint64]string{
	...
	syscall.SYS_KDEBUG_TYPEFILTER:              "kdebug_typefilter",
	syscall.SYS_KDEBUG_TRACE_STRING:            "kdebug_trace_string",
	syscall.SYS_KDEBUG_TRACE64:                 "kdebug_trace64",
	...
	syscall.SYS_THREAD_SELFCOUNTS:              "thread_selfcounts",
	...
	syscall.SYS_SYSCTLBYNAME:                   "sysctlbyname",
	...
	syscall.SYS_KEVENT_QOS:                     "kevent_qos",
	syscall.SYS_KEVENT_ID:                      "kevent_id",
	...
	syscall.SYS_PSELECT_NOCANCEL:               "pselect_nocancel",
	...
	syscall.SYS_MEMORYSTATUS_CONTROL:           "memorystatus_control",
	syscall.SYS_GUARDED_OPEN_NP:                "guarded_open_np",
	syscall.SYS_GUARDED_CLOSE_NP:               "guarded_close_np",
	syscall.SYS_GUARDED_KQUEUE_NP:              "guarded_kqueue_np",
	syscall.SYS_CHANGE_FDGUARD_NP:              "change_fdguard_np",
	syscall.SYS_USRCTL:                         "usrctl",
	syscall.SYS_PROC_RLIMIT_CONTROL:            "proc_rlimit_control",
	syscall.SYS_CONNECTX:                       "connectx",
	syscall.SYS_DISCONNECTX:                    "disconnectx",
	syscall.SYS_PEELOFF:                        "peeloff",
	syscall.SYS_SOCKET_DELEGATE:                "socket_delegate",
	syscall.SYS_TELEMETRY:                      "telemetry",
	syscall.SYS_PROC_UUID_POLICY:               "proc_uuid_policy",
	syscall.SYS_MEMORYSTATUS_GET_LEVEL:         "memorystatus_get_level",
	syscall.SYS_SYSTEM_OVERRIDE:                "system_override",
	syscall.SYS_VFS_PURGE:                      "vfs_purge",
	syscall.SYS_SFI_CTL:                        "sfi_ctl",
	syscall.SYS_SFI_PIDCTL:                     "sfi_pidctl",
	syscall.SYS_COALITION:                      "coalition",
	syscall.SYS_COALITION_INFO:                 "coalition_info",
	syscall.SYS_NECP_MATCH_POLICY:              "necp_match_policy",
	syscall.SYS_GETATTRLISTBULK:                "getattrlistbulk",
	syscall.SYS_CLONEFILEAT:                    "clonefileat",
	syscall.SYS_OPENAT:                         "openat",
	syscall.SYS_OPENAT_NOCANCEL:                "openat_nocancel",
	...
	syscall.SYS_GETATTRLISTAT:                  "getattrlistat",
	syscall.SYS_PROC_TRACE_LOG:                 "proc_trace_log",
	syscall.SYS_BSDTHREAD_CTL:                  "bsdthread_ctl",
	syscall.SYS_OPENBYID_NP:                    "openbyid_np",
	syscall.SYS_RECVMSG_X:                      "recvmsg_x",
	syscall.SYS_SENDMSG_X:                      "sendmsg_x",
	syscall.SYS_THREAD_SELFUSAGE:               "thread_selfusage",
	syscall.SYS_CSRCTL:                         "csrctl",
	syscall.SYS_GUARDED_OPEN_DPROTECTED_NP:     "guarded_open_dprotected_np",
	syscall.SYS_GUARDED_WRITE_NP:               "guarded_write_np",
	syscall.SYS_GUARDED_PWRITE_NP:              "guarded_pwrite_np",
	syscall.SYS_GUARDED_WRITEV_NP:              "guarded_writev_np",
	syscall.SYS_RENAMEATX_NP:                   "renameatx_np",
	syscall.SYS_MREMAP_ENCRYPTED:               "mremap_encrypted",
	syscall.SYS_NETAGENT_TRIGGER:               "netagent_trigger",
	syscall.SYS_STACK_SNAPSHOT_WITH_CONFIG:     "stack_snapshot_with_config",
	syscall.SYS_MICROSTACKSHOT:                 "microstackshot",
	syscall.SYS_GRAB_PGO_DATA:                  "grab_pgo_data",
	syscall.SYS_PERSONA:                        "persona",
	syscall.SYS_WORK_INTERVAL_CTL:              "work_interval_ctl",
	syscall.SYS_GETENTROPY:                     "getentropy",
	syscall.SYS_NECP_OPEN:                      "necp_open",
	syscall.SYS_NECP_CLIENT_ACTION:             "necp_client_action",
	syscall.SYS___NEXUS_OPEN:                   "__nexus_open",
	syscall.SYS___NEXUS_REGISTER:               "__nexus_register",
	syscall.SYS___NEXUS_DEREGISTER:             "__nexus_deregister",
	syscall.SYS___NEXUS_CREATE:                 "__nexus_create",
	syscall.SYS___NEXUS_DESTROY:                "__nexus_destroy",
	syscall.SYS___NEXUS_GET_OPT:                "__nexus_get_opt",
	syscall.SYS___NEXUS_SET_OPT:                "__nexus_set_opt",
	syscall.SYS___CHANNEL_OPEN:                 "__channel_open",
	syscall.SYS___CHANNEL_GET_INFO:             "__channel_get_info",
	syscall.SYS___CHANNEL_SYNC:                 "__channel_sync",
	syscall.SYS___CHANNEL_GET_OPT:              "__channel_get_opt",
	syscall.SYS___CHANNEL_SET_OPT:              "__channel_set_opt",
	syscall.SYS_ULOCK_WAIT:                     "ulock_wait",
	syscall.SYS_ULOCK_WAKE:                     "ulock_wake",
	syscall.SYS_FCLONEFILEAT:                   "fclonefileat",
	syscall.SYS_FS_SNAPSHOT:                    "fs_snapshot",
	syscall.SYS_TERMINATE_WITH_PAYLOAD:         "terminate_with_payload",
	syscall.SYS_ABORT_WITH_PAYLOAD:             "abort_with_payload",
	syscall.SYS_NECP_SESSION_OPEN:              "necp_session_open",
	syscall.SYS_NECP_SESSION_ACTION:            "necp_session_action",
	syscall.SYS_SETATTRLISTAT:                  "setattrlistat",
	syscall.SYS_NET_QOS_GUIDELINE:              "net_qos_guideline",
	syscall.SYS_FMOUNT:                         "fmount",
	syscall.SYS_NTP_ADJTIME:                    "ntp_adjtime",
	syscall.SYS_NTP_GETTIME:                    "ntp_gettime",
	syscall.SYS_OS_FAULT_WITH_PAYLOAD:          "os_fault_with_payload",
	syscall.SYS_MAXSYSCALL:                     "maxsyscall",
	syscall.SYS_INVALID:                        "invalid",
}
