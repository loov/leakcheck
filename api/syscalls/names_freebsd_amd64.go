...
var Name = map[uint64]string{
	...
	syscall.SYS___GETCWD:               "__getcwd",               // { int __getcwd(char *buf, u_int buflen); }
	...
	syscall.SYS___CAP_RIGHTS_GET:       "__cap_rights_get",       // { int __cap_rights_get(int version, \
	...
	syscall.SYS_CAP_RIGHTS_LIMIT:       "cap_rights_limit",       // { int cap_rights_limit(int fd, \
	syscall.SYS_CAP_IOCTLS_LIMIT:       "cap_ioctls_limit",       // { int cap_ioctls_limit(int fd, \
	syscall.SYS_CAP_IOCTLS_GET:         "cap_ioctls_get",         // { ssize_t cap_ioctls_get(int fd, \
	syscall.SYS_CAP_FCNTLS_LIMIT:       "cap_fcntls_limit",       // { int cap_fcntls_limit(int fd, \
	syscall.SYS_CAP_FCNTLS_GET:         "cap_fcntls_get",         // { int cap_fcntls_get(int fd, \
	...
	syscall.SYS_FUTIMENS:               "futimens",               // { int futimens(int fd, \
